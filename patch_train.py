...
def split_train_val(args, per_val=0.1):
    ...
    loader_type = 'patch'
    labels = np.load(pjoin('data', 'train', 'train_labels.npy'))  ###加载标签
...
def train(args):
    ...
    log_dir = os.path.join('runs-patch', current_time +
                           "_{}".format(args.arch))
    ...
    for arg in vars(args):
        ...
        writer.add_text('/home/qnwang/code/F3seismic/Parameters/', text)
    ...
    for epoch in range(args.n_epoch):
        ...
        for i, (images, labels) in enumerate(trainloader):
            ...
            if i in numbers:
                ...
                writer.add_image('/home/qnwang/code/F3seismic/train/original_image',
                ...
                writer.add_image('/home/qnwang/code/F3seismic/train/original_label',np_to_tb(correct_label_decoded), epoch + 1)
                ...
                writer.add_image('/home/qnwang/code/F3seismic/train/predicted', np_to_tb(decoded), epoch + 1)
                writer.add_image('/home/qnwang/code/F3seismic/train/confidence', tb_confidence, epoch + 1)
                ...
                for channel in range(0, len(class_names)):
                    ...
                    writer.add_image(f'/home/qnwang/code/F3seismic/train/train_classes/_{class_names[channel]}', tb_channel, epoch + 1)
        ...
        if args.per_val != 0:
            with torch.no_grad():  # operations inside don't track history
                ...
                for i_val, (images_val, labels_val) in tqdm(enumerate(valloader)):
                    ...
                    outputs_val = F.interpolate(outputs_val, size=labels_val.shape[-2:], mode='bilinear', align_corners=False)
                    ...
                    if i_val in numbers:
                        ...
                        tb_original_image = vutils.make_grid(
                            image_original[0][0], normalize=True, scale_each=True)
                        writer.add_image('/home/qnwang/code/F3seismic/val/original_image',
                                         tb_original_image, epoch)
                        labels_original = labels_original.numpy()[0]
                        correct_label_decoded = train_set.decode_segmap(
                            np.squeeze(labels_original))
                        writer.add_image('/home/qnwang/code/F3seismic/val/original_label',
                        ...
                        writer.add_image('/home/qnwang/code/F3seismic/val/predicted', np_to_tb(decoded), epoch + 1)
                        writer.add_image('/home/qnwang/code/F3seismic/val/confidence',
                        ...
                        for channel in range(0, len(class_names)):
                            ...
                            writer.add_image(
                                f'/home/qnwang/code/F3seismic/val/val_classes/_{class_names[channel]}', tb_channel, epoch + 1)
...
###parser.add_argument('--arch',default='网络模型')
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Hyperparams')
    parser.add_argument('--arch', nargs='?', type=str, default='segformer',
                        help='Architecture to use [\'patch_deconvnet_skip, section_deconvnet_skip, segformer, usegformer, usegformerhyper\']')
